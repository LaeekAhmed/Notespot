...
export async function getPresignedUrl(fileName: string, fileType: string, fileSize: number, token: string): Promise<APIResponse<{ presignedUrl: string; fileName: string; fileUrl: string }>> {
